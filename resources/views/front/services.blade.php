                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <!-- logo-1 -->
                                <a href="index.blade.php" class="big-logo"><img src="assets/img/logo/logo.png" alt=""></a>
                                <!-- logo-2 -->
                                <a href="index.blade.php" class="small-logo"><img src="assets/img/logo/loder-logo.png"
                                                                                  alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a href="#">Haqida</a>
                                            <ul class="submenu">
                                                <li><a href="#">Markaz faoliyati</a></li>
    ...
    <main>
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-xl-8">
                            <div class="hero-cap hero-cap2 pt-120">
                                <h2>Muhandislik texnikasi va amaliyotga joriy etish</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="services-details-area">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="single-services section-padding">
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Tel: +95 123-45-89</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 ">
                        <div class="footer-copy-right">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ...
                                “Arxitektura-qurilish” uyushmasi vebsayti by <a
