                    ...
                    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="submenu_id" class="form-control @error('submenu_id') is-invalid @enderror">
                                        @foreach($submenus as $submenu)
                                            <option value="{{ $submenu->id }}">{{ $submenu->name_uz }}</option>
                                        @endforeach
                                    </select>
                                    @error('submenu_id')
                                ...
                                <div class="form-group">
                                    <label>Body (UZ)</label>
                                    <textarea name="body_uz" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Body (RU)</label>
                                    <textarea name="body_ru" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Body (EN)</label>
                                    <textarea name="body_en" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
