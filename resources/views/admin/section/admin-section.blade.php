                    ...
                    <div class="card-statistic-4">
                        <div class="align-items-center justify-content-between">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 pr-0 pt-3">
                                    <div class="card-content">
                                        <h5 class="font-15">Uyushma a'zolari</h5>
                                        <h2 class="mb-3 font-18">{{ $membersCount }}</h2>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pl-0 text-right">
                                    <div class="banner-img">
                    ...
                    <div class="card-statistic-4">
                        <div class="align-items-center justify-content-between">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 pr-0 pt-3">
                                    <div class="card-content">
                                        <h5 class="font-15">Murojatlar</h5>
                                        <h2 class="mb-3 font-18">{{ $commentsCount }}</h2>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pl-0 text-right">
                                    <div class="banner-img">
                                        <i data-feather="mail" class="icon-lg text-warning"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
